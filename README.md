...
## Javascript Assignments  [![Build Status](https://travis-ci.org/yaroslav-levotsky/js-assignments.svg?branch=master)](https://travis-ci.org/yaroslav-levotsky/js-assignments)
...
* Run `git clone https://github.com/yaroslav-levotsky/js-assignments.git` from command line to download the repo.
...
```
* Open https://github.com/yaroslav-levotsky/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/yaroslav-levotsky/js-assignments/builds).
